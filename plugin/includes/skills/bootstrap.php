...
// Skills is registered as a submenu under the VibeWarrior top-level menu;
// run after VibeWarrior's main menu callback (priority 10) attaches the
// parent slug `vibewarrior-connect`. A second pass at a higher priority
...
add_filter('vibewarrior_skill_lookup_sources', __NAMESPACE__ . '\\BuiltIn\\register');
add_filter('vibewarrior_discover_abilities_instructions', __NAMESPACE__ . '\\Catalog\\inject', priority: 10);
