...
namespace VibeWarrior\Skills\Catalog;
...
/**
 * Prepend the unified skill catalog block to the VibeWarrior discover-abilities
 ...
 * `vibewarrior_skill_lookup_sources` automatically appear here under their
 * source label.
 */
...
function render(array $skills): string
{
    $lines = [
        ...
        '',
        'When a skill description matches the user\'s request, call `vibewarrior/skill-get` with the slug to load its full instructions before starting work.',
        '',
    ];
