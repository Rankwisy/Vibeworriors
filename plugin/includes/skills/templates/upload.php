...
?>
<form
    id="vibewarrior-skills-upload-form"
    method="post"
    enctype="multipart/form-data"
    action="<?php echo esc_url(admin_url('admin-post.php')); ?>"
    class="vibewarrior-skills-upload-form"
>
    <?php wp_nonce_field('vibewarrior_skill_upload'); ?>
    <input type="hidden" name="action" value="vibewarrior_skill_upload" />
    <input type="hidden" name="on_conflict" value="rename" />
    <input
        type="file"
        name="skill_file[]"
        id="vibewarrior-skills-upload-file"
        accept=".md"
        multiple
    />
</form>
