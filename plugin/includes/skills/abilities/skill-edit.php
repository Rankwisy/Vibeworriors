...
namespace VibeWarrior\Skills\Abilities\SkillEdit;
...
function register(): void
{
    ...
    wp_register_ability('vibewarrior/skill-edit', [
        'label' => __('Edit Skill', domain: 'vibewarrior'),
        'description' => __(
...
function execute(array $input): array|WP_Error
{
    ...
    if (array_key_exists('description', $input)) {
        ...
        if ($new_description === '') {
            return new WP_Error('missing_description', __('Description cannot be empty.', domain: 'vibewarrior'));
        }
