...
namespace VibeWarrior\Skills\Abilities\SkillDelete;
...
function register(): void
{
    ...
    wp_register_ability('vibewarrior/skill-delete', [
        'label' => __('Delete Skill', domain: 'vibewarrior'),
        'description' => __(
            'Move a VibeWarrior user skill to trash. Pass `permanent=true` to skip trash and delete immediately.',
            domain: 'vibewarrior',
        ),
        'category' => 'skill',
        'input_schema' => [
