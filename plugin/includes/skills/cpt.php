...
namespace VibeWarrior\Skills\Cpt;

if (!defined('ABSPATH')) {
    exit();
}

const POST_TYPE = 'vibewarrior_skill';
...
{
    $capability = \vibewarrior_manage_capability();
    ...
    register_post_type(POST_TYPE, [
        ...
        'has_archive' => false,
        'rewrite' => false,
        'capability_type' => ['vibewarrior_skill', 'vibewarrior_skills'],
        'map_meta_cap' => true,
        'capabilities' => [
            'read' => $capability,
    ...
    $auth = static fn(): bool => \vibewarrior_current_user_can_manage();
